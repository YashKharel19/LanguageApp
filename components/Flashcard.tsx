...
export default function Flashcard({
    ...
    const speak = (text: string, audioFile?: any) => {
        if ((language === "Nepali" || language === "Punjabi" || language === "Bengali" || language === "French" || language === "Gujarati" || language === "Hindi" || language === 'Kannada' || language === 'Korean' || language === 'Malayalam' || language === 'Persian') && audioFile) {
            playAudio(audioFile);
        } else {
